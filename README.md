...
```
$ s2i build https://github.com/SilkeRoth/nginx-ex centos/nginx-112-centos7 mynginximage
...
`$ oc new-app centos/nginx-112-centos7~https://github.com/SilkeRoth/nginx-ex`

You can also deploy the sample template for the application:

`$ oc new-app -f https://raw.githubusercontent.com/SilkeRoth/nginx-ex/master/openshift/templates/nginx.json`
